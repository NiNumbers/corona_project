...
active_apps <- c(566894, 746942, 806570, 855080, 915965)
app_data <- data.frame(datum = seq(as.Date("2020/06/25"), 
                                   (as.Date("2020/06/25")+(length(active_apps))-1), "days"), 
...
CHkum <- c(1, 8, 12, 21, 27, 42, 58, 90, 116, 210, 264, 337, 389, 509, 645, 858, 1125, 1359, 1650, 2200, 2650, 3028, 
           ...
           31200, 31217, 31243, 31292, 31310, 31332, 31376, 31428, 31486, 31555, 31617, 31652, 31714, 31851) 
...
verstorbenCHkum <- c(19, 21, 33, 43, 56, 60, 66, 86, 103, 161, 197, 235, 257, 295, 373, 378, 432, 484, 540, 559, 584, 641, 
                     ...
                     1678, 1678, 1680, 1680, 1680, 1680, 1680, 1682, 1682, 1682, 1682, 1682, 1682, 1684, 1685)
...
DEkum <- c(0, 0, 0, 0, 0, 0, 0, 0, 57, 150, 188, 240, 349, 534, 684, 847, 1150, 1565, 2369, 3062, 4838, 6012, 9352, 12327, 
           ...
           192786, 193257, 193790, 194403, 194693, 194898, 195042, 195758)
...
USkum <- c(15, 16, 51, 57, 58, 60, 68, 74, 98, 118, 149, 217, 262, 402, 518, 583, 959, 1300, 1700, 2200, 2700, 3500, 4600, 
           ...
           2422312, 2467837, 2510323, 2549069, 2590582, 2636538) 
