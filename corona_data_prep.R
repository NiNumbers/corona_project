...
DEkum <- append(DEkum_, c(206751, 207382, 207960, 208819, 209736, 210676, 211086))
ITkum <- append(ITkum_, c(246118, 246286, 246488, 246776, 247158, 247537, 247832))
USkum <- append(USkum_, c(4234140, 4294770, 4352083, 4427493, 4495224, 4563262, 4620502))
